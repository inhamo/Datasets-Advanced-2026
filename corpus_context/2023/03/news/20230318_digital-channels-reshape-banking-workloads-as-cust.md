...
Industry data reviewed by analysts suggests active digital customers rose by about 22.4% year on year across mid-tier retail banks, while e-wallet and app-led transactions grew by an estimated 16.8%. The gains were strongest in urban provinces, but USSD remained important for lower-income and intermittent-data customers.
...
Loan-payment data adds another layer. In March 2023, comparable files showed a 6.4% failed-payment rate, suggesting that some customers targeted for digital offers may also be experiencing cash-flow stress.
